...
<link rel="stylesheet" type="text/css" media="screen" href="<?=$this->link->template_url('css/main.css');?>?v=8" />
...
<script type="text/javascript" src="<?=$this->link->template_url('js/main.js');?>?v=8"></script>
<script type="text/javascript" src="<?=$this->link->template_url('js/jquery.functions.js');?>?v=8"></script>
