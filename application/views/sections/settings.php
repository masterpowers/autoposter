...
?>
                            ...
                            <tr>
                                <td class="txt-wrap">
                                    <label class="lbl-3"><?=LNG_FIELD_APP_API_VERSION;?></label>
                                </td>
                                <td class="field-wrap" colspan="2">
                                    <div class="input-1 w300 lt<?=$data['facebook_app']['error']['class_app_version'];?>">
                                        <input type="text" id="field_app_version" name="field_app_version" value="<?=$data['facebook_app']['field_app_version'];?>"/>
                                    </div>
                                    <div class="info tooltip lt">
                                        <div class="popup v2">
                                            <div class="inner">
                                                <p><?=LNG_FIELD_APP_API_VERSION_INFO;?></p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
